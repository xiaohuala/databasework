					...
					<div class="media">
						<div class="media-left">
							<div class="avatar avatar-lg avatar-circle">
								<img class="img-responsive" src="/OAManagerSys/upload/employee/${missionInfo.auther.pic }" alt="avatar"/>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="m-h-lg lh-xl">
								<!--<p><c:if test="${missionInfo.pic!=null }"><img src="D:/upload/${missionInfo.pic }" width="300" height="300"></c:if></p> -->
								 <p><c:if test="${missionInfo.pic!=null }"><img src="/OAManagerSys/upload/mission/${missionInfo.pic }" width="300" height="300"></c:if></p>
								...
								<form action="delete_comment.action" method="post">	
									...
									<div class="media-left">
										<div class="avatar avatar-lg avatar-circle">
											...
											<img src="/OAManagerSys/upload/employee/${map.key.pic  }" >
										</div>
									</div>
						...
						<c:otherwise>
							...
							<div class="media stream-post">
								...
								<div class="media-body">
									...
									<!--一条评论结束	<p>${missionInfo.text }</p>-->
										<p><span id="b1" ></span>%的概率是<span id="a1"></span></p>
										<p><span id="b2"></span>%的概率是<span id="a2"></span></p>
										<p><span id="b3"></span>%的概率是<span id="a3"></span></p>
										<script type="text/javascript">
										var json= ${missionInfo.text };
										document.getElementById("a1").innerHTML=(json.result[0].name)
										document.getElementById("b1").innerHTML=((json.result[0].score).toFixed(3)*100)
										document.getElementById("a2").innerHTML=(json.result[1].name)
										document.getElementById("b2").innerHTML=((json.result[1].score).toFixed(3)*100)
										document.getElementById("a3").innerHTML=(json.result[2].name)
										document.getElementById("b3").innerHTML=((json.result[2].score).toFixed(3)*100)
										</script>
